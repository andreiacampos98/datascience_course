#Linha 1 Importar os dados do ficheiro Carros3 para uma DataFrame chamada Carros3 Carolina L.
import pandas as pd
import numpy as np
...
#Linha 2 Avaliar os principais indicadores das variáveis quantitativas do DataFrame Carros3 Yhoanna
...
#Linha 3 Criar uma nova variável length_min_max através da transformação Min-Max aplicada a length. Sara
...
#Linha 4 Criar uma nova variável width_std através da estandardização da variável width. Filipa
#Validar se os novos valores da variável são os previstos pela transformação.
print("---------------------------------------- Estandadização-----------------------------------")
Carros3['width_std']=(Carros3['width'] -Carros3['width'].mean())/(Carros3['width'].std())
print(Carros3.describe())

#Linha 5 Criar uma nova variável height_log através de uma transformação Logarítmica aplicada a height. Ana
#Validar se os novos valores da variável são os previstos pela transformação.
print("---------------------------------------- Logaritmica-----------------------------------")
Carros3['height_log']=np.log1p(Carros3['height'])
print(Carros3.describe())

#Linha 6 Criar uma nova variável price_decile através da transformação em decis da variável price. Rui
#Validar se os novos valores da variável são os previstos pela transformação.
print("---------------------------------------- 10 decis-----------------------------------")
...
#Linha 7 Exportar os dados de Carros3 num ficheiro csv com o nome Carros4 Joan
